...
void Set_System(void)
{
  ...
  // SysTick (относительно 9ћ√ц)
  
  SysTick->LOAD  = 9000000 / SysTickFreq - 1;// 100√ц                          /* set reload register */
...
* Return         : None.
*******************************************************************************/
uint32_t CDC_Send_DATA (const uint8_t *ptrBuffer, uint8_t Send_length)
{
